...
require (
	github.com/flc1125/go-cron/middleware/distributednooverlapping/redismutex/v4 v4.5.1
	github.com/flc1125/go-cron/middleware/distributednooverlapping/v4 v4.5.1
	github.com/flc1125/go-cron/middleware/nooverlapping/v4 v4.5.1
	github.com/flc1125/go-cron/middleware/otel/v4 v4.5.1
	github.com/flc1125/go-cron/middleware/recovery/v4 v4.5.1
